...
public interface SocialUserDAO {
    ...
    List<TBLSocialUser> findByProviderId(String providerId);

    List<TBLSocialUser> findByUserId(Long userId);

    List<TBLSocialUser> findByUserIdAndProviderId(String userId, String providerId);

    List<TBLSocialUser> findByUserIdAndProviderUserIds(String userId, MultiValueMap<String, String> providerUserIds);

    TBLSocialUser get(String userId, String providerId, String providerUserId);

    TBLSocialUser get(String providerId, String providerUserId);
    
    List<TBLSocialUser> findPrimaryByUserIdAndProviderId(String userId, String providerId);
